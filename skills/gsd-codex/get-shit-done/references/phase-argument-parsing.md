...
```bash
PHASE_INFO=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}" --raw)
```
