...
```bash
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js init new-milestone)
```
...
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js config-set workflow.research true

# If "Skip research": persist false
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js config-set workflow.research false
```
...
Use template: ~/.codex/skills/gsd-codex/get-shit-done/templates/research-project/{FILE}
</output>
...
**Commit requirements:**
```bash
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
