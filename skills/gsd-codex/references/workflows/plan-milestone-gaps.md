...
PHASES=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js phases list)
...
```bash
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md
```
