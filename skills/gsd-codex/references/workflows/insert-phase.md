...
```bash
INIT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js init phase-op "${after_phase}")
```
...
```bash
RESULT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js phase insert "${after_phase}" "${description}")
```
