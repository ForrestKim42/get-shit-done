...
<required_reading>
@~/.codex/skills/gsd-codex/get-shit-done/references/verification-patterns.md
@~/.codex/skills/gsd-codex/get-shit-done/templates/verification-report.md
</required_reading>
...
```bash
INIT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE_ARG}")
```
...
```bash
node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js roadmap get-phase "${phase_number}"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js frontmatter get "$plan" --field must_haves)
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js verify key-links "$plan")
...
See ~/.codex/skills/gsd-codex/get-shit-done/templates/verification-report.md for complete template.
</step>
