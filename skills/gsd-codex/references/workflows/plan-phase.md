...
@~/.codex/skills/gsd-codex/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
INIT=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js init plan-phase "$PHASE" --include state,roadmap,requirements,context,research,verification,uat)
```
...
```bash
PHASE_INFO=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
```
...
```bash
PHASE_DESC=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}" | jq -r '.section')
...
STATE_SNAP=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js state-snapshot)
...
```
Task(
  prompt="First, read ~/.codex/skills/gsd-codex/references/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
```
Task(
  prompt="First, read ~/.codex/skills/gsd-codex/references/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
