...
```bash
TRANSITION=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node ~/.codex/skills/gsd-codex/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
