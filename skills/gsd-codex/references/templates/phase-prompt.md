...
<!-- For checkpoint task examples and patterns, see @~/.codex/skills/gsd-codex/get-shit-done/references/checkpoints.md -->
...
See `~/.codex/skills/gsd-codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `~/.codex/skills/gsd-codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `~/.codex/skills/gsd-codex/get-shit-done/workflows/verify-phase.md` for verification logic.
